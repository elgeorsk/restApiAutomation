...
public class Basics {
    public static void main(String[] args){
        ...
        //addPlace - POST
        String responseAddPlace = given().queryParam("key",key).header("Content-Type", "application/json")
        ...
        //updatePlace - PUT
        String responseUpdatePlace = given().queryParam("key",key).header("Content-Type", "application/json")
